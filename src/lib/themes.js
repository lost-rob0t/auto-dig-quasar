...
export const THEMES = Object.freeze([
  ...
  },
  {
    ...
    tokens: { bg: "#090806", deep: "#050403", panel: "#12100b", panel2: "#1a1710", surface: "#0e0c08", line: "#4b452f", text: "#e8e6df", strong: "#f5f3ed", muted: "#b2ada1", accent: "#e3b92f", accent2: "#f0d47a", warm: "#d89a26", danger: "#d45b45", success: "#4fb8aa", purple: "#aa8643", pink: "#c96a54", orange: "#cf8b2f", teal: "#4fb8aa", blue: "#7eb8aa", neutral: "#716b5d" }
  },
  {
